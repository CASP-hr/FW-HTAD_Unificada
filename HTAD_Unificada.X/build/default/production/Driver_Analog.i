...
static uint16_t adc_values_an0[10];
static uint16_t adc_values_an1[10];
static uint16_t adc_values_an3[10];
...
uint16_t Driver_Analog_GetValueAN0() {
    ...
    uint16_t averageValue = (uint16_t)(sum / 10);
