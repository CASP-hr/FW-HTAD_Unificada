...
# 1 "./DriverADT7410TRZ.h" 1
# 13 "./DriverADT7410TRZ.h"
...
# 1 "C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC18F-K_DFP/1.7.134/xc8\\pic\\include\\__null.h" 1 3
...
void SRV_ADT7410_ReadMeanSensor(Sensor_e address,TypeRead_e typeRead , float *value)
{
    ...
    static uint16_t meanDianteiro[50] = {0};
    static uint16_t meanTraseiro[50] = {0};
    static uint16_t meanUmidade[50] = {0};
    ...
    if(temp)
    {
        if(address == SENSOR_S1)
        {
            ...
            valueMean = (uint16_t)(valueAux / 50);
            valueAux = 0;
